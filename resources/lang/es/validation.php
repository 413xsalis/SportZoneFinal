...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Estas son las traducciones por defecto de los mensajes de validación de
    | Laravel. Puedes modificarlas libremente según tus necesidades.
    |
    */
    ...
    'password'             => [
        ...
        'uncompromised' => 'El :attribute dado aparece en una filtración de datos. Elige otro.',
    ],
    ...
    |--------------------------------------------------------------------------
    | Aquí puedes traducir nombres de atributos a un formato más legible.
    |
    */

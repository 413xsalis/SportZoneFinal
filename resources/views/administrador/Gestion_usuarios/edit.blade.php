...
@section('content')
    <style>
        ...
        :root {
            ...
            --success-color: #4cc9f0;       /* Color para elementos de éxito */
        ...
        .form-control-modern, .form-select-modern {
            ...
            transition: all 0.3s ease;      /* Transición para efectos focus */
        }
        
        .form-control-modern:focus, .form-select-modern:focus {
            border-color: var(--primary-color); /* Borde color primario al enfocar */
            box-shadow: 0 0 0 0.25rem rgba(67, 97, 238, 0.15); /* Sombra de enfoque */
        }
        ...
        .required-field::after {
            ...
            color: #e74a3b;                 /* Color rojo para indicar obligatoriedad */
        }
        ...
        .section-title {
            ...
            border-bottom: 2px solid var(--primary-color); /* Línea inferior decorativa */
        }
        ...
        .footer-actions {
            ...
            border-radius: 16px;
            box-shadow: var(--card-shadow);
            position: sticky;               /* Posición fija al hacer scroll */
        ...
        .select2-container--default .select2-selection--multiple {
            ...
            min-height: 46px;               /* Altura mínima consistente */
        }
        ...
        .file-upload-container {
            border: 2px dashed #e2e8f0;     /* Borde discontinuo */
            border-radius: 12px;
            padding: 1.5rem;
            text-align: center;
        ...
        .file-upload-container:hover {
            border-color: var(--primary-color);
            background-color: rgba(67, 97, 238, 0.05); /* Fondo sutil al pasar mouse */
        }
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-modern" id="name" name="name" 
                                               value="{{ old('name', $usuario->name) }}" required> <!-- Valor antiguo o actual -->
                                        @error('name')
                                ...
                                <select name="roles[]" id="roles" class="form-control form-select-modern" multiple="multiple" required>
                                    @foreach($roles as $role)
                                        <option value="{{ $role->name }}" {{ $usuario->hasRole($role->name) ? 'selected' : '' }}>
                                            {{ $role->name }} <!-- Marca como seleccionados los roles actuales -->
                                        </option>
                                    @endforeach
                                </select>
                                @error('roles')

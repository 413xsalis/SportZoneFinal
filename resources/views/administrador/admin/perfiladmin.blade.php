                    ...
                    <div class="profile-card">
                        <div class="p-3">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist">
                                ...
                                <a class="nav-link" id="v-pills-documentos-tab" data-bs-toggle="pill"
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                                ...
                                <div class="card-body p-4">
                                    <form action="{{ route('profile.update') }}" method="POST"
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-6">
                                                <label for="documento_identidad" class="form-label fw-semibold">Documento de
                                                    identidad <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control shadow-sm" id="documento_identidad"
                                                    name="documento_identidad"
                                                    value="{{ old('documento_identidad', Auth::user()->documento_identidad) }}"
                                                    required>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="fecha_nacimiento" class="form-label fw-semibold">Fecha de
                                                    nacimiento</label>
                                            ...
                                            <div class="col-md-6">
                                                <label for="telefono" class="form-label fw-semibold">Número de
                                                    teléfono</label>
                                                <input type="tel" class="form-control shadow-sm" id="telefono"
                                                    name="telefono" value="{{ old('telefono', Auth::user()->telefono) }}">
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-12">
                                                <label for="direccion_hogar" class="form-label fw-semibold">Dirección de
                                                    hogar</label>
                                                <textarea class="form-control shadow-sm" id="direccion_hogar"
                                                    name="direccion_hogar"
                                                    rows="3">{{ old('direccion_hogar', Auth::user()->direccion_hogar) }}</textarea>
                                            </div>
                                        </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-documentos" role="tabpanel"
                            ...
                            <div class="profile-card">
                                ...
                                <div class="card-body p-4">
                                    <form action="{{ route('profile.uploadDocument') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-4">
                                            <label for="foto_documento" class="form-label fw-semibold">Foto del documento
                                                <span class="text-danger">*</span></label>
                                            <input type="file" class="form-control shadow-sm" id="foto_documento"
                                                name="foto_documento" accept="image/*">
                                            <div class="form-text text-muted mt-2">Suba una imagen clara de ambos lados de
                                                su documento de identidad.</div>
                                        </div>
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <div class="document-thumbnail d-inline-block">
                                                    <img src="{{ asset('storage/' . Auth::user()->foto_documento) }}"
                                                        alt="Documento de identidad" class="img-fluid"
                            ...
                            <div class="profile-card">
                                ...
                                <div class="card-body p-4">
                                    <form action="{{ route('profile.changePassword') }}" method="POST">
                                        @csrf
                                        <div class="mb-4">
                                            <label for="current_password" class="form-label fw-semibold">Contraseña
                                                actual</label>
                                            <input type="password" class="form-control shadow-sm" id="current_password"
                                                name="current_password">
                                        </div>
                                        <div class="mb-4">
                                            <label for="new_password" class="form-label fw-semibold">Nueva
                                                contraseña</label>
                                            <input type="password" class="form-control shadow-sm" id="new_password"
                                                name="new_password">
                                            <div class="form-text text-muted mt-2">Use al menos 8 caracteres con una
                                                combinación de letras, números y símbolos.</div>
                                        </div>
                                        <div class="mb-4">
                                            <label for="new_password_confirmation" class="form-label fw-semibold">Confirmar
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('perfilinst.uploadLogo') }}" method="POST" enctype="multipart/form-data"
                            id="logoForm">
                            @csrf
                            <div class="mb-3">
                                <label for="logo" class="form-label fw-semibold">Seleccionar imagen</label>
                                <input class="form-control shadow-sm" type="file" id="logo" name="logo"
                                    accept=".jpeg,.jpg,.png,.gif,.webp,.avif">
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary rounded-pill px-3" form="logoForm">Guardar
                            cambios</button>
                    </div>
                </div>
            </div>

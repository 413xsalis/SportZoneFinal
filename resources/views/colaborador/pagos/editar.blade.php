                    ...
                    <div class="card-body">
                        ...
                        @if ($errors->any())
                            <div class="alert alert-danger">
                                <strong><i class="fas fa-exclamation-triangle"></i> Ups!</strong> Corrige los siguientes
                                errores:
                                <ul class="mt-2 mb-0">
                        ...
                        <form action="{{ route('pagos.pagos.update', $pago->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="fecha_pago" class="form-control" value="{{ $pago->fecha_pago }}"
                                    required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="medio_pago" class="form-select" required>
                                    <option value="efectivo" {{ $pago->medio_pago == 'efectivo' ? 'selected' : '' }}>Efectivo
                                    </option>
                                    <option value="nequi" {{ $pago->medio_pago == 'nequi' ? 'selected' : '' }}>Nequi</option>
                                    <option value="daviplata" {{ $pago->medio_pago == 'daviplata' ? 'selected' : '' }}>
                                        Daviplata</option>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="estado" class="form-select" required>
                                    ...
                                    <option value="Pendiente" {{ $pago->estado == 'Pendiente' ? 'selected' : '' }}>Pendiente
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="estudiante_documento" class="form-select" required>
                                    @foreach($estudiantes as $estudiante)
                                        <option value="{{ $estudiante->documento }}" {{ $pago->estudiante_documento == $estudiante->documento ? 'selected' : '' }}>

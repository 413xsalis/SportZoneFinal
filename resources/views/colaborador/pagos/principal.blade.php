            ...
            <div class="app-container">
                ...
                <div class="app-title">
                    <div class="d-flex align-items-center">
                        <div>
                            <h1 class="mb-4"><i class="bi bi-people me-2"></i> Gestion de pagos</h1>
                            ...
                            <div class="card-modern">
                                <div class="option-card">
                                    <div>
                                        ...
                                        <p class="text-muted">Gestiona los pagos de inscripción de nuevos clientes.
                                            Registra, consulta y actualiza la información de inscripciones.</p>
                                    </div>
                            ...
                            <div class="card-modern">
                                <div class="option-card">
                                    <div>
                                        ...
                                        <p class="text-muted">Administra los pagos mensuales de los clientes. Consulta
                                            estados de cuenta, registra pagos y genera recordatorios.</p>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center mt-4">
                                        <span class="badge bg-success">Activo</span>
                                        <div class="d-flex align-items-center text-primary">

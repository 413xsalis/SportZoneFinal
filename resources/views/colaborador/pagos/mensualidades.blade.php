                ...
                <form action="{{ route('pagos.mensualidades.store') }}" method="POST" id="mensualidadForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="valor" id="valor"
                                class="form-control" min="0" max="10000000" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="año" id="año" class="form-control" min="2025" max="2100"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        conceptoInput.placeholder = `Ej: Mensualidad ${mesActual} ${añoActual}`; // Validación del formulario
        const form = document.getElementById('mensualidadForm');
        form.addEventListener('submit', function(e) {
            const valor = document.getElementById('valor').value;
            if (valor <= 0) {
                ...
                e.preventDefault();
                alert('El valor de la mensualidad no puede superar los 10,000,000');
                document.getElementById('valor').focus();
            }
        });

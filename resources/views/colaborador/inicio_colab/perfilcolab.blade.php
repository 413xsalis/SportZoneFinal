...
@section('content')
    <main class="content">
        ...
        : 'https://ui-avatars.com/api/?name=' . urlencode(Auth::user()->name) . '&size=150&background=random' }}"
                                    class="rounded-circle shadow" id="profileAvatar"
                        ...
                        <div class="col-md-3 text-md-end mt-3 mt-md-0">
                            @if(Auth::user()->logo_personalizado)
                                <img src="{{ asset('storage/' . Auth::user()->logo_personalizado) }}" alt="Logo Personalizado"
                                    class="mb-2 img-fluid" style="max-height:40px;">
                            @endif
                            <br>
                    ...
                    <div class="card shadow-sm border-0 rounded-3">
                        <div class="card-body p-0">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist">
                                ...
                                <a class="nav-link d-flex align-items-center py-3 px-3" id="v-pills-security-tab"
                ...
                <div class="col-lg-9">
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel">
                            <div class="card shadow-sm border-0 rounded-3">
                                <div class="card-header bg-light">
                                    <h5 class="mb-0 fw-semibold"><i class="bi bi-person-circle me-2 text-primary"></i>
                                        Información Personal</h5>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('perfilcolab.update') }}" method="POST"
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                <label for="documento_identidad" class="form-label">Documento de identidad
                                            ...
                                            <div class="col-12">
                                                ...
                                                <textarea class="form-control" id="direccion_hogar" name="direccion_hogar"
                                                    rows="3">{{ old('direccion_hogar', Auth::user()->direccion_hogar) }}</textarea>
                                            </div>
                                        </div>

                                        <div class="text-end mt-4">
                                            <button type="submit" class="btn btn-primary px-4">Actualizar
                                                información</button>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-documentos" role="tabpanel">
                            <div class="card shadow-sm border-0 rounded-3">
                                <div class="card-header bg-light">
                                    <h5 class="mb-0 fw-semibold"><i class="bi bi-id-card me-2 text-primary"></i> Documentos
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('perfilcolab.uploadDocument') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-3">
                                            <label for="foto_documento" class="form-label">Foto del documento <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        @if(Auth::user()->foto_documento)
                                            <div class="mt-3">
                                                ...
                                                <img src="{{ asset('storage/' . Auth::user()->foto_documento) }}"
                                                    alt="Documento de identidad" class="img-thumbnail shadow-sm"

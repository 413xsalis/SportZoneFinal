...
@section('content')
< @section('title', 'Crear estudiante') <! @section('content') <div class="col-md-12 mb-4">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function filtrarSubgrupos() {
        ...
        for (let option of subgrupoSelect.options) {
            ...
            option.style.display = option.getAttribute("data-grupo") === grupoId ? "block" : "none";
        }
        subgrupoSelect.value = ""; // reset al cambiar grupo
    }

    grupoSelect.addEventListener("change", filtrarSubgrupos);
    filtrarSubgrupos(); // ejecutar al cargar
});
</script>

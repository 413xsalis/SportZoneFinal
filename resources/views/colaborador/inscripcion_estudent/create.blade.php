                    ...
                    <form action="{{ route('estudiantes.store') }}" method="POST" id="estudianteForm">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="eps" id="eps" value="{{ old('eps') }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="id_subgrupo" id="id_subgrupo" class="form-select">
                                    ...
                                    @foreach ($subgrupos as $subgrupo)
                                        <option value="{{ $subgrupo->id }}" data-grupo="{{ $subgrupo->grupo_id }}" {{ old('id_subgrupo') == $subgrupo->id ? 'selected' : '' }}>
                                            {{ $subgrupo->nombre }}
                                        </option>
                                    @endforeach
                                </select>

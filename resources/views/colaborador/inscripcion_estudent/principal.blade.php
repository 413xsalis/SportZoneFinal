            ...
            <div class="app-container">
                <div class="app-title">
                    <div class="d-flex align-items-center">
                        <div>
                            <h1 class="mb-4"><i class="bi bi-people me-2"></i> Inscripción de Estudiantes</h1>
                ...
                <div class="filter-section">
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex justify-content-end">
                            <select class="form-select me-2" id="grupoFilter"
                                        ...
                                        @foreach ($estudiantes as $est)
                                            <tr data-grupo="{{ $est->grupo ? $est->grupo->id : 'no_group' }}">
                                                ...
                                                <td class="action-buttons">
                                                    ...
                                                    <form action="{{ route('estudiantes.cambiarEstado', $est->documento) }}"
                                                        method="POST" class="d-inline">
                                                        @csrf
                                                        @method('PATCH')
                                                        <button type="submit" class="btn btn-sm btn-outline-warning"
                                                            title="Inactivar"
                                                            onclick="return confirm('¿Estás seguro de inactivar este estudiante?')">
                                                            <i class="bi bi-person-x"></i>
                                                        </button>
                                                    </form>
                                                </td>

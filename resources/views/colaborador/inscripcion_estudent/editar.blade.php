        ...
        <div class="app-container">
            ...
            <div class="card card-modern">
                <div class="card-header card-header-modern">
                    <h5 class="mb-0"><i class="bi bi-person-check me-2"></i> Editar Estudiante: {{ $estudiante->nombre_1 }}
                        {{ $estudiante->apellido_1 }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('estudiantes.update', $estudiante->documento) }}" method="POST"
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="{{ route('colaborador.inscripcion') }}"
                                class="btn btn-secondary btn-modern">Cancelar</a>

        ...
        <div class="row mb-4">
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <p class="text-muted">Clases esta semana</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="stats-card">
            ...
            <div class="col-lg-4">
                <div class="card card-modern h-100">
                    ...
                    <div class="card-body p-0">
                        <img src="{{ asset('assets/images/imagen.jpg') }}" alt="Deportes" class="img-fluid rounded-bottom" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="list-group" id="notificationList">
                            ...
                            <div class="list-group-item notification-item">
                                <div class="d-flex w-100 justify-content-between">
                                    ...
                                    <small class="text-muted">{{ \Carbon\Carbon::parse($asistencia->fecha)->format('d/m/Y H:i') }}</small>
                                </div>
                                <p class="mb-1">Estudiante: <strong>{{ $asistencia->estudiante->nombre_1 }} {{ $asistencia->estudiante->apellido_1 }}</strong></p>
                                <p class="mb-1">Subgrupo: <strong>{{ $asistencia->subgrupo->nombre ?? 'N/A' }}</strong></p>
                                <small class="text-muted">Estado: 
                                    <span class="badge {{ $asistencia->estado == 'asistió' ? 'bg-success' : 'bg-danger' }}">
                                        {{ $asistencia->estado }}
                                    </span>
                                </small>
                            </div>

        ...
        <div class="app-container">
            ...
            <div class="app-title">
                <div class="d-flex align-items-center">
                    ...
                    @endif
                    <div>
                        <h1 class="mb-1"><i class="bi bi-clipboard-check me-2"></i> Reportes</h1>
                    ...
                    <form method="GET" action="{{ route('inst.reporte.asistencias') }}">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" name="fecha" id="fecha" class="form-control form-control-modern" value="{{ request('fecha') }}" required>
                            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>{{ $asistencia->estudiante->nombre ?? 'N/A' }}</div>
                                            </div>
                                        </td>
